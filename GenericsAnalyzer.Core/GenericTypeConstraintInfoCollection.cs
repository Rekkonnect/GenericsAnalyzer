...
namespace GenericsAnalyzer.Core
{
    ...
    {
        private Dictionary<ISymbol, GenericTypeConstraintInfo> finalizedSymbols = new Dictionary<ISymbol, GenericTypeConstraintInfo>(SymbolEqualityComparer.Default);
        private Dictionary<ISymbol, GenericTypeConstraintInfo.Builder> builders = new Dictionary<ISymbol, GenericTypeConstraintInfo.Builder>(SymbolEqualityComparer.Default);
