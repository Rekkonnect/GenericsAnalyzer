...
namespace GenericsAnalyzer.Core
{
    ...
    public sealed class InheritTypeConstraintsAttribute : Attribute, IGenericTypeConstraintAttribute
    {
        ...
        /// Prefer using <see langword="nameof"/>(...) for each inheriting type parameter. For functions, this solution is unavaiable, therefore raw string literals will have to be used.
        /// </param>
